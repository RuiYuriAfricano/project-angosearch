...
if($_SESSION['nome_admin']) {
    ...
    if(isset($_POST['remover'])) {
        ...
        if(mysqli_num_rows($p) > 0):
            ...
            $del = $con->query("update login set estado='1',dtActivado='$dataActivado' where fk_utilizador='$id'
and estado='0' and acesso='utilizador'")
            ...
            header("Location:view_utilizador.php?msg=senhaerror");
        endif;
    ...
    <head>
        <meta charset="UTF-8">
        <title>Activar utilizador | Angosearch</title>
    ...
    <div class="lockscreen-wrapper">
        ...
        <!-- User name -->
        <div class="lockscreen-name">Activar utilizador  " <?php echo $nome; ?> "</div><br>
        ...
        <div class="text-center">
            <a href="view_utilizador.php">Regressar a página anterior</a>
        </div>
