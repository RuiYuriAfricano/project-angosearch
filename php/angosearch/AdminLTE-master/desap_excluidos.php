...
if($_SESSION['nome_admin']) {
 ...
 and estado='0'")
    ...
    <head>
        <meta charset="UTF-8">
        <title>Excluídos | Angosearch</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Visualizar</li> <li class="active">Excluídos</li>
                </ol>
            ...
            <section class="content">
                ...
                <div class="row" id="resumo">
                    ...
                    <!--================End Welcome Area =================-->
                    <center>
                        <div class="table-responsive" style="  width: 100%;background-color: #fff;
margin-bottom: 30px; padding-bottom: 10px; padding-top: 10px; margin-top: 30px; padding-left: 20px;padding-right: 20px;">
                            ...
                            $desaparecidos = $con->query("select * from desaparecidos where estado='3'");
...
`desaparecidos`,bairro,genero,provincia WHERE estado = '3' and fk_bairro=id_bairro and fk_genero=id_genero
 and fk_provincia=id_provincia ORDER  BY  id_desaparecido DESC ");


                            ?>
                            <h5 align="left" style=""><?php if($totalDesaparecidos > 1){
                                    echo $totalDesaparecidos." Pessoas Excluídas";}
                                else if($totalDesaparecidos == 0){
                                    echo "Nenhuma Pessoa Excluída";
                                }
                                if($totalDesaparecidos == 1){
                                    echo $totalDesaparecidos." Pessoa Excluída";}
                                ?> </h5>
                            ...
                            <table  style="text-align: center;"  width="100%" id="example2" class="table table-bordered table-hover" >
                                <thead style="color: #fff;background-color: #3c8dbc"> <tr >
                                    ...
                                    <th width="96" align="center">Excluído(a) desde</th>
                                    <th width="96" align="center">Excluído(a) por</th>
                                    <th width="192" align="center"><a href="view_desaparecidos.php">
                                            <button class="btn btn-default" style="">Pessoas Desaparecidas</button>
                                        </a></th>
