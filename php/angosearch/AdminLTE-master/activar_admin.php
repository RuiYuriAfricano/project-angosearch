...
if($_SESSION['nome_admin']) {
    ...
    if(isset($_POST['remover'])) {
        ...
        if(mysqli_num_rows($p) > 0):
            ...
            $del = $con->query("update login set estado='1',dtActivado='$dataActivado' where id_login='$id' and estado='0'
and acesso='admin'")
    ...
    <head>
        <meta charset="UTF-8">
        <title>Activar ADMIN | Angosearch</title>
    ...
    <div class="lockscreen-wrapper">
        ...
        <!-- User name -->
        <div class="lockscreen-name">Activar ADMIN  " <?php echo $nome; ?> "</div>
