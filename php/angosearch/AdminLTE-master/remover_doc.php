...
if($_SESSION['nome_admin']) {
    ...
    if(isset($_POST['remover'])) {
        ...
        $del = $con->query("update documentos set estado='0', dataExcluido='$dataExcluido',
dataEncontrado='$data',removido_por='$n' where id_doc='$id'
 and estado='1'")
    ...
    <head>
        <meta charset="UTF-8">
        <title>Remover Documento Perdido | Angosearch</title>
...
<br>
        ...
        <div class="lockscreen-item">
            ...
            <form class="lockscreen-credentials" action="" method="post">
                <div class="input-group" style="border-bottom: solid ">Quando foi Encontrado ?
