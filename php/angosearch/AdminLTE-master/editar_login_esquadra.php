...
if($_SESSION['nome_admin']) {
    ...
    $esq = $_GET['esquadra'];
    $func = $_GET['func_foto'];
    $func_esquadra  = $_GET['func_esquadra'];
    if(empty($id)){
        echo" <script>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Editar Usuário | Angosearch</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                  <span class="glyphicon glyphicon-edit"></span>   Editar Usuário do(a) funcinário(a) : <?php echo $func_esquadra; ?>
                    <small>Painel de Controlo</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-circle-o"></i> Esquadra</a></li>
                    <li class="active">Visualizar</li><li class="active">Ver Usuário</li><li class="active">Editar Usuário</li>
                </ol>
            </section>
                ...
                <div class="row" id="resumo">
                    ...
                    <div class="col-md-6">
                        <div class="box box-primary">
                            ...
                            <!-- form start -->
                            <form role="form" method="post" action="processa_editar_login.php" >
                                <div class="box-body" style="border-bottom: solid #333">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="hidden" class="form-control"  name="loginID" value="<?php echo $id; ?>">
                                    </div>
