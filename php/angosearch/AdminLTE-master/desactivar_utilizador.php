...
if($_SESSION['nome_admin']) {
    ...
    if(isset($_POST['remover'])) {
        ...
        if(mysqli_num_rows($p) > 0):
            ...
            $del = $con->query("update login set estado='0',dtDesactivado='$dataDesactivado' where fk_utilizador='$id'
and estado='1' and acesso='utilizador'")
    ...
    <head>
        <meta charset="UTF-8">
        <title>Desactivar utilizador | Angosearch</title>
    ...
    <div class="lockscreen-wrapper">
        ...
        <!-- User name -->
        <div class="lockscreen-name">Desactivar utilizador  " <?php echo $nome; ?> "</div><br>
