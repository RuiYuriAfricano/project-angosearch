...
if ( !$_SESSION['utilizador']) {
 ...
 VALUES (DEFAULT ,'$id_ut', '$comentario.', '$fk_desaparecido', '$data','1')");
            if ($insere === FALSE) {
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 mb-3 mb-lg-0">
                                ...
                                <textarea class="form-control" name="comentario" style="color: #222;" id="" cols="3" rows="3"
                                          placeholder="Escreva o teu Comentário Aqui" required="required"></textarea>
                            </div>
                        </div>
                                                    ...
                                                    <?php if($_SESSION['utilizador']==$dados1['nome_completo']): ?>
                                                        <div class='timeline-footer'>
                                                            ...
                                                            <a class="btn btn-warning btn-flat btn-xs"
                                                               href="editar_comentario.php?id_comment=<?php echo ($dados1['id_comentario']);?>
                                                               && fk_ds=<?php echo ($dados1['fk_desaparecido']);?>" >Editar</a>
