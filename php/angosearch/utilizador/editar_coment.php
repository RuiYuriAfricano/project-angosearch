...
if ( !$_SESSION['utilizador']) {
    ...
    $c=$con->query("SELECT id_comentario,comentario,fk_desaparecido,data_comentario,nome_completo,foto
            FROM comentario,utilizador WHERE  id_comentario='$id_comment' and id_utilizador=utilizador and estado_comment='1'
                                            ORDER  BY  id_comentario  DESC  LIMIT 1 ");

    if(isset($_POST['editar'])) {

        $comment = utf8_decode($_POST['comentario']);
        ...
        header("Location:index.php");// enviado com sucesso
            }
        } catch (Exception $e) {
...
?>
                ...
                <h2 class="section-title mb-3" style="color: #555;">Editar Comentário</h2>

                <form method="post" action="" data-aos="fade" style="color: #000;">



                            <textarea class="form-control" name="comentario" style="color: #222; width: 50%" id="" cols="3" rows="6"
...
<br>
                            ...
                            </button>  <a class="btn btn-danger" href="index.php" />
