...
desaparecidos,bairro,genero,provincia WHERE estado = '1' and fk_bairro=id_bairro and fk_genero=id_genero
 and fk_provincia=id_provincia ORDER  BY  id_desaparecido DESC LIMIT 9 ")
        ...
        ?><center id="sectionPessoas"> <h2 ><a href="todosDesaparecidos.php" style="color: #666;">Pessoas Desaparecidas</a></h2></center>
                ...
                <div class="item">
                    <div class="causes_item">
                        ...
                        <div class="causes_bottom">
                            <a href="maisDesaparecidos.php?id_desaparecido=<?php echo ($dado['id_desaparecido']);?> ">Saber Mais</a>
        ...
        <div class="causes_slider owl-carousel" >
            ...
            <div class="item">
                <div class="causes_item">
                    ...
                    <div class="causes_bottom">
                        <a href="saberDoc.php?id_doc=<?php echo ($dado['id_doc']);?> ">Saber Mais</a>
